...
@php
    ...
    //     $dashboard_url = View::getSection('dashboard_url') ?? config('adminlte.dashboard_url', 'admin.dashboard');

    // } elseif ($role == 'user') {
    //     //$dashboard_url = route('user.dashboard');
    //     $dashboard_url = View::getSection('dashboard_url') ?? config('adminlte.dashboard_url', 'user.dashboard');
    // }
